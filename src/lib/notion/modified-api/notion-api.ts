...
export class NotionAPI {
      ...
      if (
        ...
        if (source) {
          if (
            ...
            !source.includes("prod-files-secure.s3")
          ) {
            return [];
          }
          return {
  ...
  public async getPageRaw(
    ...
    return this.fetchData<notion.PageChunk>({
  ...
  public async getCollectionData(
    ...
    return this.fetchData<notion.CollectionInstance>({
  ...
  public async getUsers(userIds: string[]) {
    return this.fetchData<notion.RecordValues<notion.User>>({
  ...
  public async getSignedFileUrls(urls: types.SignedUrlRequest[]) {
    return this.fetchData<types.SignedUrlResponse>({
  ...
  public async search(params: notion.SearchParams) {
    ...
    return this.fetchData<notion.SearchResults>({
      endpoint: "search",
      body,
    });
  }
